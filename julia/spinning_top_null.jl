...
function spinning_top!(dy, y, p, t)
    ...
    ac[1:6] = copy(([S' * M; A]\[S' * f; b])[1:6])
    dy[7:12] = copy(([S' * M; A]\[S' * f; b - bg[1] * h1 - bg[2] * h0])[1:6])
end
